...
class QuantizedAutoregressiveAudio(SequenceDataset):
    ...
    def setup(self):
        from s4.src.dataloaders.audio import QuantizedAudioDataset
...
class MaestroAutoregressive(SequenceDataset):
    ...
    def setup(self):
        from s4.src.dataloaders.audio import MaestroDataset
...
class SpeechCommands09Classification(SequenceDataset):
    ...
    def setup(self):
        from s4.src.dataloaders.audio import _SpeechCommands09Classification
...
class SpeechCommandsGeneration(SequenceDataset):
    ...
    def setup(self):
        from s4.src.dataloaders.datasets.sc import _SpeechCommandsGeneration
...
class Music(SequenceDataset):
    ...
    def setup(self):
        from s4.src.dataloaders.music import _Music
