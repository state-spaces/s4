...
from s4.src.models.sequence.rnns.cells.basic import RNNCell
from s4.src.models.nn import LinearActivation, Activation # , get_initializer
from s4.src.models.nn.gate import Gate
