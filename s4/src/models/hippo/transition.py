...
try:
    from s4.extensions.legt.legt import legt_gbt_forward, legt_gbt_backward, legt_gbt_forward_t, legt_gbt_backward_t
except:
    pass

try:
    from s4.extensions.trid.trid import trid_gbt_forward, trid_gbt_backward, trid_solve
except:
    pass
