...
from s4.src.models.functional.toeplitz import triangular_toeplitz_multiply, triangular_toeplitz_multiply_padded
from s4.src.utils.permutations import bitreversal_po2, bitreversal_permutation
