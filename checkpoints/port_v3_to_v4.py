...
def port_a(state_dict):
    """Port to A_real and A_imag."""
    new_state_dict = {}
    for k, v in state_dict.items():
...
def port_checkpoint(ckpt_path):
    ...
    new_state_dict = port_dt(state_dict)
    new_state_dict = port_a(new_state_dict)
...
def main(config: OmegaConf):
    ...
    # Port checkpoint
    checkpoint = port_checkpoint(ckpt_path)
